...
export default function GuestbookComments({ avatarSrc, avatarFallback, nameHandle, date, message }: GuestbookCommentsProps) {
    return (
            ...
            <div className="flex items-start gap-4 text-sm">
                ...
                <div className="grid gap-1.5">
                    <div className="flex items-center gap-2">
                        <div className="font-semibold">{nameHandle}</div>
