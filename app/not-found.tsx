    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-5 max-md:flex-col max-md:items-stretch max-md:gap-0">
                ...
                >
                    <AnimatedElement initialOpacity={0} duration={0.2} delay={0.2} className="flex grow flex-col items-stretch pr-8 max-md:mt-10 max-md:max-w-full max-md:pr-5">
                ...
                <AnimatedElement initialOpacity={0} duration={0.5} delay={0.5} x={15} className="ml-5 flex w-[46%] flex-col items-stretch max-md:ml-0 max-md:w-full">
                    <Icons.errorpage />
                </AnimatedElement>
            </div>
        </AnimatedElement>
