...
import { signIn, signOut } from 'next-auth/react';
import Image from 'next/image';
import { BookOpenIcon, ShieldCloseIcon } from 'lucide-react';
            ...
            <div className="flex h-16 justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    <Menu.Items className="ring-opacity-5/5 absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black focus:outline-none">
                      {user ? (
                        <Menu.Item>
                          {({ active }) => (
                            <button
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2">
                  <span className="sr-only">Open main menu</span>
                  {open ? (
                    <ShieldCloseIcon className="block h-6 w-6" aria-hidden="true" />
                  ) : (
