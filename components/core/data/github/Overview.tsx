...
const Overview = ({ data }: OverviewProps) => {
  ...
  const bestContribution = totalContributionList.length > 0 ? Math.max(...totalContributionList) : 0;
  const averageContribution = totalContributions > 0 ? totalContributions / totalContributionList.length : 0;
...
export default Overview;import OverviewItem from "./OverviewItem"
