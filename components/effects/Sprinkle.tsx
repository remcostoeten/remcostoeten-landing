...
// The `Sprinkle` component is a React component that displays a sprinkle effect with stars.It accepts the following props:

// - `t1`: A string that will be displayed before the sprinkle effect.
// - `t2`: A string that will be displayed after the sprinkle effect.
// - `children`: The children to be rendered within the sprinkle effect.
// - `className`: A string to add additional CSS classes to the component.

// ## Usage

// Here's an example of how to use the `Sprinkle` component:
