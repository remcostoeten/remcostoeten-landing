...
export default function Sprinkle({
  ...
  const starRefs = Array.from({ length: starCount }, () =>
  ...
  return (
    <div
      className={`${className} text-cream`}
        ...
        {Array.from({ length: starCount }).map((_, index) => (
          ...
          >
            <svg
              fill={starColor}
              viewBox="0 0 512 512"
              style={{ opacity: opacity, position: "relative", zIndex: -1 }}
            >
              <path
                fill={starColor}
