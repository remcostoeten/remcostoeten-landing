                        ...
                        >
                            <div className='flex items-center gap-3 border-b border-neutral-300 px-4 dark:border-neutral-800'>
                                ...
                                <Combobox.Input
                                    ...
                                    className='font-sora h-14 w-full border-0 bg-transparent text-neutral-800 placeholder:text-neutral-500 focus:outline-none focus:ring-0 dark:text-neutral-200'
                                    placeholder={
                                                        ...
                                                        >
                                                            ...
                                                            <>
                                                                {isActiveRoute(child?.href) ? (
                                                                    <span className='font-sora animate-pulse text-xs text-neutral-500'>
                                                                        You are here
                                                                    </span>
                                                                ) : (
                                                                    <>
                                                                        {child?.type && (
                                                                            <div className='font-sora rounded-md border border-neutral-400 px-1.5 py-0.5 text-xs text-neutral-500 dark:border-neutral-500'>
                                                                                {child?.type}
                                                                            </div>
                                                                        )}
                                                                    </>
