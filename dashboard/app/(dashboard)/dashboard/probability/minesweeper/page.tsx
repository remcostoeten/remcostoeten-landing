...
const Minesweeper: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedOpenedTilesCount)
      setOpenedTilesCount(JSON.parse(savedOpenedTilesCount));
  ...
  return (
    <div className="text-center mt-8">
      ...
      Ja hehe, waar was je al die tijd? Ben een tijdje naar Pristina (kosovo)
      geweest
      <button
        onClick={resetGame}
      ...
      <div className="flex ">
        ...
        <ResultsSidebar
          reset={clearAll}
          timesDied={numDeaths}
          saveClickedPerRound={saveClickedPerRound}
    ...
    <Wrapper>
      <Table>
        <ResetIcon
          height={30}
          width={30}
          className="absolute top-4 t right-4"
          onClick={reset}
        />
