...
const App: React.FC = () => {
    ...
    const multiplierValuesVariant1 = [1.22, 1.54, 1.97, 2.55, 3.35, 4.47, 6.07, 8.41, 11.92, 17.33];

    // Multipliers for a 7x7 grid with 5 bombs
    const multiplierValuesVariant2 = [1.09, 1.21, 1.36, 1.52, 1.72, 1.94, 2.19, 2.49, 2.84, 3.24, 3.72, 4.28, 4.95, 5.75, 6.71, 7.8, 9.27, 10.99, 13.11, 15.73, 19.01, 23.14, 28.4, 35];

    const calculateProbability = () => {
        if (useVariant2 && totalTiles !== 49) {
            alert('Invalid input! For variant 2, the total tiles should be 49 (7x7 grid).');
            return;
        }
        ...
        if (tilesToOpen > 0) {
            ...
            const multiplier = useVariant2 ? multiplierValuesVariant2[multiplierIndex] : multiplierValuesVariant1[multiplierIndex];
