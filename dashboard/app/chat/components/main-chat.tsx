    ...
    <div className="flex flex-col pb-20 max-md:max-w-full">
            ...
            <section className="flex flex-col grow max-md:max-w-full">
              <div className="flex flex-col justify-center px-4 py-20 tracking-wide text-white max-md:pr-5 max-md:max-w-full">
                <div className="flex gap-3 items-start mt-6 mb-80 max-md:flex-wrap max-md:mb-10">
                  <Image
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/6bfc0c23759211747cf382e25841f88fb2a9402074148602cd916ba95b451ec0?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                    alt="Virtual Agent"
          ...
          <aside className="flex flex-col ml-5 w-[27%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center py-20 mx-auto w-full bg-black border-l border-solid border-l-zinc-800">
              <div className="flex gap-5 justify-center px-4 py-3.5 w-full shadow-sm bg-white bg-opacity-0">
                <div className="my-auto text-sm s-6 text-white">Topic List</div>
                <div className="flex flex-1 gap-0.5">
                  <Image
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/bd64f04e318451597174d92f5b46c93484c170ab177bd3fb9875a48c3cc89578?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                    alt="Plus"
                    className="shrink-0 w-6 aspect-square"
                  />
                  <Image
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/080df74e8da9003ff3e0bf5c3efcdb095e9d137299081f5e3e6ef24400a75ab2?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                    alt="Dots"
                    className="shrink-0 w-6 aspect-square"
                  />
                </div>
              ...
              <div className="flex flex-col py-px mt-1.5 w-full rounded-md border border-solid border-zinc-800">
                <div className="flex gap-0 self-end">
                  <Image
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/25cd61f3a5342568f075cc525442849b7a0b4f36ff671e3ac1b1deaf316d4dd8?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                    alt="Topic List"
                    className="shrink-0 max-w-full aspect-[1.67] w-[200px]"
                  />
                  <Image
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/ea144d4a091d32242225603e11b68698a0d6b54f0a110090d087beac5eaa4ab7?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                    alt="Close"
              ...
              <div className="flex gap-3 items-center py-2.5 pr-20 pl-3.5 mt-2 rounded-md bg-white bg-opacity-10 max-md:pr-5">
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/2bf488b3be6b782e29bf7df15adb47b802e2a3430bf7efd614f76b490bf4a84c?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                  alt="Checkmark"
      ...
      <div className="flex gap-5 justify-center px-4 py-3 mt-0 w-full border-b border-solid border-b-zinc-800 max-md:flex-wrap max-md:mt-0 max-md:max-w-full">
        <div className="flex gap-3 max-md:flex-wrap">
          <Image
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/fc0bfeea211f49ceb57535d131460880003743096db3941181db5d94140a7025?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
            alt="Just Chat"
            className="shrink-0 w-10 aspect-square"
          />
          <div className="flex flex-col self-start max-md:max-w-full">
            <div className="flex gap-2 pr-20 max-md:flex-wrap max-md:pr-5">
              ...
              <Badge>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/2cd1dc918f703fff27059a8ed7e240c0bad06834e94f016c4b7188d33d321a93?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
                  alt="Model"
        ...
        <div className="flex gap-2 my-auto">
          <Image
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/00accdc3d83eda4b1b7ab1399a2f4dd667e1525131b516f36e7b6c9555a60ccd?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
            alt="Settings"
            className="shrink-0 w-9 aspect-square"
          />
          <Image
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/c0396b4a071c98c81296ef0b9b115b937f9510a9eb673752aebdcca48a8f24ab?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
            alt="Expand"
            className="shrink-0 w-9 aspect-square"
          />
          <Image
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/411c01f8987918a21b3985589b1cd0d422db5e8ed8f6695b1a713b9452c3515b?apiKey=3cf1db2ab1694ce4be6d4ee2ec473197&"
            alt="Close"
            className="shrink-0 w-9 aspect-square"
          />
        </div>
