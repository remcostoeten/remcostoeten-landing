...
type DeleteFunction = (
  ...
  deleteSnippet: DeleteFunction,
) => Promise<void>;
type UpdateFunction = (
  id: string,
  newData: Partial<Category>,
  updateCategory: UpdateFunction,
  updateSnippet: UpdateFunction,
) => Promise<void>;

// Export the CRUD operations as functions
export const handleDelete: DeleteFunction = async (
  id: string,
  deleteCategory: DeleteFunction,
  deleteSnippet: DeleteFunction,
) => {
...
export const handleUpdate: UpdateFunction = async (
  id: string,
  newData: Partial<Category>,
  updateCategory: UpdateFunction,
  updateSnippet: UpdateFunction,
