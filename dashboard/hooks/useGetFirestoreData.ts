...
import { onSnapshot, doc, updateDoc, deleteDoc, collection, CollectionReference, QuerySnapshot } from "firebase/firestore";
...
export function useFirestoreCollection<T>(collectionName: string): FirestoreHookReturnType<T> {
