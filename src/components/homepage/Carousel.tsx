    ...
    return (
        <section>
            <div className="space-y-2">
                ...
                />
                <SectionSubHeading>
                    <p className="dark:text-neutral-400">Some stuff over at <a href="https://snippets.remcostoeten.com" target='_blank' className='underline'>snippets.remcostoeten.com</a>.</p>
                </SectionSubHeading>
            </div>
            <div
