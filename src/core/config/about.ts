...
export const experiences: Experience[] = [
  {
    ...
    details: [
      "SaaS provider exclusively for non-profit organizations and governments. Primairly working on the Pleio-platform (Intranet builder for non-profit organizations and governments in React, GraphQL). but also various tax and politic-heavy applications. Everything fully WCAG compliant and open source.",
    ],
    projects: [
      {
        name: "FSV Portaal",
